  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
      ...
      <div className="space-y-4">
        ...
        {/* Map Placeholder */}
        <div className="h-32 bg-gradient-to-br from-blue-100 to-green-100 rounded-lg flex items-center justify-center border border-gray-200">
          <div className="text-center">
            <Globe className="h-8 w-8 text-gray-400 mx-auto mb-2" />
            <p className="text-sm text-gray-500">Interactive 3D map visualization</p>
            <p className="text-xs text-gray-400">(Three.js implementation coming soon)</p>
          </div>
        </div>
      </div>
    </div>
